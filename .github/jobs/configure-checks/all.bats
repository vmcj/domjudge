...
q_configure () {
    su $u -c "./configure $@"
    #./configure $@ --with-domjudge-user=root
}
...
@test "Alternative dirs together with FHS" {
   skip
   setup
   run q_configure "--enable-fhs --with-domserver_webappdir=/run/webapp --with-domserver_tmpdir=/tmp/domserver --with-judgehost_tmpdir=/srv/tmp --with-judgehost_judgedir=/srv/judgings --with-judgehost_chrootdir=/srv/chroot/domjudge --with-judgehost_cgroupdir=/sys/fs/altcgroup"
   assert_line " * prefix..............: /usr/local"
   assert_line " * documentation.......: /usr/local/share/doc/domjudge"
   assert_line " * domserver...........: "
   assert_line "    - bin..............: /usr/local/bin"
...
@test "Alternative dirs together with defaults" {
   skip
   setup
   run q_configure "--with-judgehost_tmpdir=/srv/tmp --with-judgehost_judgedir=/srv/judgings --with-judgehost_chrootdir=/srv/chroot --with-judgehost_cgroupdir=/sys/fs/altcgroup --with-domserver_logdir=/log"
   assert_line " * prefix..............: /opt/domjudge"
   assert_line " * documentation.......: /opt/domjudge/doc"
   assert_line " * domserver...........: /opt/domjudge/domserver"
   refute_line "    - log..............: /opt/domjudge/domserver/log"
...
@test "Default URL not set, docs mention" {
  ...
  assert_line " * documentation.......: /opt/domjudge/doc"
  run q_configure "--with-baseurl=https://contest.example.org"
...
@test "Change users" {
  ...
  run q_configure "--with-domjudge-user=other_user --with-webserver-group=other_group --with-runuser=other-domjudge-run --with-rungroup=other-run-group"
...
@test "No docs" {
  ...
  run q_configure
  assert_line " * documentation.......: /opt/domjudge/doc"
  run q_configure --enable-doc-build
  assert_line " * documentation.......: /opt/domjudge/doc"
  run q_configure --disable-doc-build
