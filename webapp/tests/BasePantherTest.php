...
/**
 * Class BasePantherTest
 *
 * This abstract class mimics the BaseTest for Panther (heavier) tests.
 *
 * @package App\Tests
 */
abstract class BasePantherTest extends PantherTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->client = self::createPantherClient(['browser' => static::FIREFOX]);
    ...
    protected function logIn(): void
    {
        ...
        /** @var User $user */
        $user = $doctrine->getRepository(User::class)->findOneBy(['username' => 'demo']);
        ...
        /*$this->loginHelper('demo','demo','/login',200);
        $this->client->navigate('GET', '/login');*/
        /*$session = self::$container->get('session');
