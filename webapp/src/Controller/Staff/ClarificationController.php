...
class ClarificationController extends AbstractController
{
    ...
    /**
     * @Route("", name="staff_clarifications")
     */
    ...
    /**
     * @Route("/{id<\d+>}", name="staff_clarification")
     */
    ...
    /**
     * @Route("/send", methods={"GET"}, name="staff_clarification_new")
     */
    ...
    /**
     * @Route("/{clarId<\d+>}/claim", name="staff_clarification_claim")
     */
    public function toggleClaimAction(Request $request, int $clarId): Response
    {
        ...
        if($request->request->getBoolean('claimed')) {
            ...
            $this->em->flush();
            return $this->redirectToRoute('staff_clarification', ['id' => $clarId]);
        } else {
            $clarification->setJuryMember(null);
            $this->em->flush();
            return $this->redirectToRoute('staff_clarifications');
        }
    }

    /**
     * @Route("/{clarId<\d+>}/set-answered", name="staff_clarification_set_answered")
     */
    ...
    /**
     * @Route("/{clarId<\d+>}/change-subject", name="staff_clarification_change_subject")
     */
    ...
    /**
     * @Route("/{clarId<\d+>}/change-queue", name="staff_clarification_change_queue")
     */
    ...
    /**
     * @Route("/send", methods={"POST"}, name="staff_clarification_send")
     */
    public function sendAction(Request $request): Response
    {
        ...
        if (empty($sendto)) {
            ...
            return $this->redirectToRoute('staff_clarification_send');
        } else {
